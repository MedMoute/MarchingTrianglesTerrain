using System.Text;
using Godot;
using Localproto.addons.marchingTriangles.ui;
...
public class TerrainToolPluginHelper
{
    ...
    private readonly addons.marchingTriangles.editor.gizmo.MarchingTrianglesGizmoPlugin _gizmoPlugin;
    ...
    /// </summary>
    private readonly addons.marchingTriangles.MarchingTrianglesTerrainPlugin _parent;

    internal TerrainToolPluginHelper(
        MarchingTrianglesPhysicsDelegate physicsDelegate,
        TerrainToolAttributes attributes,
        addons.marchingTriangles.editor.gizmo.MarchingTrianglesGizmoPlugin gizmoPlugin,
        MarchingTrianglesTerrainUi ui,
        addons.marchingTriangles.MarchingTrianglesTerrainPlugin parent)
    {
    ...
    protected static void PrintDebugInfoOnHoverPoint(Vector3 drawPosition)
    {
        ...
        var hoveredChk = addons.marchingTriangles.MarchingTrianglesTerrainPlugin.Instance.PluginHelper.CurrentHoveredChunk;
        sb.Append(" | [Plugin] H. chunk :")
            .Append(hoveredChk);

        var chunkScale = new Vector2D(
                             addons.marchingTriangles.MarchingTrianglesTerrainPlugin.Instance.CurTerrainNode.TerrainSettings.ChunkDimensions.X,
                             addons.marchingTriangles.MarchingTrianglesTerrainPlugin.Instance.CurTerrainNode.TerrainSettings.ChunkDimensions.Y) *
                         addons.marchingTriangles.MarchingTrianglesTerrainPlugin.Instance.CurTerrainNode.TerrainSettings.CellScale;
        var trueTriCell = triSystem.CartesianToLocal.Invoke(xzPos);
        sb.Append(" | [Exp. fr pos] H. cell :")
            .Append(trueTriCell);
        if (addons.marchingTriangles.MarchingTrianglesTerrainPlugin.Instance.CurTerrainNode
            .Chunks.TryGetValue(
                new Vector2I(
    ...
    {
        var undoRedoManager = addons.marchingTriangles.MarchingTrianglesTerrainPlugin.Instance.GetUndoRedo();
        ...
        switch (_parent.SelectedMode)
        {
            ...
            default: // Brush-based mode
                ...
                undoRedoManager.AddDoMethod(_parent, nameof(
                        addons.marchingTriangles.MarchingTrianglesTerrainPlugin.DelegateCompositePatternAction),
                    terrainNode as MarchingTrianglesTerrain,
                    doPatternVariant);
